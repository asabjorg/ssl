...
dist:
	...
	install -m 0664 src/chat.c ${COURSE}/${HOMEWORK}/src/chat.c
	install -m 0664 src/chatd.c ${COURSE}/${HOMEWORK}/src/chatd.c
	tar cvzf ${HOMEWORK}.tar ${COURSE}/${HOMEWORK}/data ${COURSE}/${HOMEWORK}/Makefile ${COURSE}/${HOMEWORK}/src/Makefile ${COURSE}/${HOMEWORK}/src/README ${COURSE}/${HOMEWORK}/src/AUTHORS ${COURSE}/${HOMEWORK}/src/chat.c ${COURSE}/${HOMEWORK}/src/chatd.c
